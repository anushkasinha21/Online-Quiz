...
<header class="header_area">
    ...
    <section class="home_banner_area" style="background: #aba9a9;background-size: cover;">
      <div class="banner_inner">
        <div class="container">
          <div class="row" style="margin-left: -12px; margin-top: 1800px;">
...
<img height="30" width="30" src="${pageContext.request.contextPath}/img/correct.png"/>
</c:if>

<c:if test='${q.userSelected != q.correctOptionIndex+1}'>
<img height="30" width="30" src="${pageContext.request.contextPath}/img/redcross.png"/>
</c:if>
<br/>
<br/>
