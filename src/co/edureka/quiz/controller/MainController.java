...
@WebServlet(urlPatterns = { "/login", "/register", "/takeExam", "/logout", "/submitQuestion", "/landing" })
	...
	protected void doGet(HttpServletRequest request,
		...
		if (request.getRequestURI().equals(applicationContextPath + "/")) {
			...
			dispatcher.forward(request, response);
				...
				applicationContextPath + "/landing")) {
			RequestDispatcher dispatcher = request
					.getRequestDispatcher("/WEB-INF/jsps/landing.jsp");
			dispatcher.forward(request, response);
		} else if (request.getRequestURI().equals(
			...
			dispatcher.forward(request, response);
				...
				applicationContextPath + "/submitQuestion")) {
			RequestDispatcher dispatcher = request
					.getRequestDispatcher("/WEB-INF/jsps/submitQuestion.jsp");
			dispatcher.forward(request, response);
		} else if (request.getRequestURI().equals(
